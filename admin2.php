		        	...
		        	<div class="slider-caption">
					    <div class="templatemo_homewrapper">
					      ...
					      <h2 class="wow fadeInDown" data-wow-delay="2000">
							<span>
							    WELCOME ADMIN   WE give YOU right &AMP VOTE <span>
						</h2>
					    </div>
				  	</div>
		        </li>
					...
					<div class="col-md-4 col-sm-4">
						<div class="media">
							...
							<div class="media-body wow fadeIn">
								...
								<p>Please do <a rel="nofollow" href="#" target="_parent"> SIGN UP </a> to VOTE. If you are already with us, then <a rel="nofollow" href="#" target="_parent"> LOG IN </a> easily.</p>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4">
				...
				<div class="row">
 					<div class="col-md-12">
						<div class="title">
							...
							<p class="wow fadeIn" data-wow-delay="0.6s">  FOR ANY CHANGES AND MODIFICATIONS  ,
							<br> 
							username : Ravilochan <br>
							password : ravilochan0508 <br>
							For 000webhost FILE MANAGER 
							<br>
							 
							
							</p>
							<p class="wow fadeInDown"  data-wow-delay="0.4s"> To make ANY DATABASSE changes :
							<br><h2 class="wow fadeIn" data-wow-delay="0.6s">  PHP  MYADMIN  <br><button class="btn btn-warning" onclick="window.location.href='https://www.000webhost.com/members/website/ravilochan/database'"> Click HERE</button>
						</P>
						</div>
